    ...
    <div className="flex h-full flex-col bg-sidebar">
      ...
      <div className="border-t border-sidebar-border p-2">
        <Link
          ...
          onClick={onNavigate}
          className="flex items-center gap-2 rounded-lg px-3 py-2.5 text-sm text-sidebar-foreground/85 transition-colors hover:bg-sidebar-accent hover:text-foreground"
        >
